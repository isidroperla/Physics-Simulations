...
QcDegreesItem *QcGaugeWidget::removeDegrees(float position)
{
    QcDegreesItem * item = new QcDegreesItem(this);
    item->setPosition(position);
...
QcValuesItem *QcGaugeWidget::removeValues(float position)
{
    QcValuesItem * item = new QcValuesItem(this);
    item->setPosition(position);
    mItems.removeLast();
...
QcLabelItem *QcGaugeWidget::removeLabel(float position){
    QcLabelItem * item = new QcLabelItem(this);
    item->setPosition(position);
    mItems.removeLast();
    return item;
